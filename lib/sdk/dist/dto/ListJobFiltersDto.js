...
exports.ListJobFiltersDto = void 0;
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const PaginationDto_1 = require("./PaginationDto");
const toArray_1 = require("../utils/toArray");
class ListJobFiltersDto extends PaginationDto_1.PaginationDto {
    constructor() {
        super(...arguments);
        this.sort = 'publishedAt:desc';
    }
}
exports.ListJobFiltersDto = ListJobFiltersDto;
__decorate([
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(toArray_1.toArray),
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['publishedAt:desc', 'publishedAt:asc']),
    __metadata("design:type", String)
